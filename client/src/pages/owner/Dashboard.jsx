...
const Dashboard = () => {
  ...
  const dashboardCards = [
    {title:"Total Vehicle",value:data.totalCars,icon:assets.carIconColored},
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="Admin Dashboard" subTitle="Monitor overall platform performance including total vehicle, bookings, revernue, and recent activities" />
