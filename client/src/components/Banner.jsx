  ...
  return (
    ...
    className={`flex flex-col md:flex-row md:items-start items-center justify-between px-8 min-md:pl-14 pt-10    ${isDark ? 'bg-gradient-to-r from-[#090979] to-[#1F1F30] text-light':'bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] text-dark'}   max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden`}>
        <div className='text-white'>
            <h2 className='text-3xl font-medium'>🚗 Own a Luxury Car? Let It Pay for Itself.</h2>
            <p className='mt-2'>Monetize your vehicle effortlessly by listing it on CarRental.</p>
            <p className='max-w-130'>Unlock the earning potential of your luxury car. PrimeDrive manages everything — from insurance to payments - so you can earn passive income, stress-free.</p>

            <button 
            whileHover={{scale:1.05}}
    whileTap={{scale:0.95}}
             className='px-6 py-2 bg-white hover:bg-slate-100 transtion-all text-primary rounded-lg text-sm mt-4 cursor-pointer'>List your car</button>
        </div>
        <motion.img 
