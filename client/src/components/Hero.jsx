...
const Hero = () => {
  ...
  return (
    <motion.div
      ...
      animate={{ y: 0, opacity: 1 }}
      transition={{ duration: 0.8 }}
      className={`flex flex-col items-center justify-center p-20 gap-14 ${
    ...
    >
      <div className="max-w-4xl flex flex-col text-center gap-10">
        ...
        <motion.h1
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.8, delay: 0.2 }}
          className="text-4xl font-semibold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent"
        >
          Welcome to{' '}
        ...
        <p className="text-lg md:text-xl text-dark dark:text-gray-400">
          <span className="block font-semibold text-indigo-600 dark:text-indigo-400 mb-2">
            Reliable. Affordable. Effortless.
          </span>
          Your ultimate destination for smart and seamless vehicle rentals.
          Whether you're planning a weekend getaway, a business trip, or just
          need a ride around town — we’ve got the perfect vehicle for every
          journey.
        </p>
      </div>
      ...
      <motion.form
        ...
        className="flex flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-full w-full max-w-80 md:max-w-200 bg-gradient-to-r from-indigo-800 via-purple-800 to-pink-800 shadow-[0px_8px_20px_rgba(0,0,0,1)]"
      >
        <div className="flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-8 text-gray-1000">
          <div className="flex flex-col items-start gap-2 text-gray-900">
            <select
